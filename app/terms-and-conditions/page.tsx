...
export default function TermsAndConditions() {
	return (
		<>
			<Navbar />
			<div className='w-full bg-white mt-20 text-gray-800'>
				{/* HERO */}
				<section className='w-full py-12 sm:py-16 md:py-32 bg-linear-to-r from-blue-600 to-cyan-400 text-white text-center'>
					<h1 className='text-3xl sm:text-4xl md:text-5xl font-bold'>
						Terms & Conditions
					</h1>
					<p className='text-white/90 mt-4 text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4'>
						Last Updated: December 06, 2025
					</p>
				</section>

				{/* CONTENT */}
				<section className='max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16 space-y-4 leading-relaxed text-sm sm:text-base md:text-lg'>
					<p>
					...
					<h3 className='text-lg sm:text-xl font-semibold'>Interpretation</h3>
					<p>
					...
					<h3 className='text-lg sm:text-xl font-semibold'>Definitions</h3>
					...
					<ul className='list-disc ml-6 space-y-3'>
						...
						<li>
							...
							&quot;Terms and Conditions&quot; agreement has been created with
						...
						<li>
							<b>Website</b> refers to Digital Haridwar, accessible from
							https://www.digitalharidwar.com
						</li>
						<li>
					...
					<h2 className='text-xl sm:text-2xl font-bold'>Acknowledgment</h2>
					<p>
					...
					<h2 className='text-xl sm:text-2xl font-bold'>Termination</h2>
					<p>
					...
					<h2 className='text-xl sm:text-2xl font-bold'>Governing Law</h2>
					<p>
					...
					<h2 className='text-xl sm:text-2xl font-bold'>Disputes Resolution</h2>
					<p>
					...
					<h3 className='text-lg sm:text-xl font-semibold'>Severability</h3>
					<p>
					...
					<h3 className='text-lg sm:text-xl font-semibold'>Waiver</h3>
					<p>
					...
					<p>By email: yogeshggangwar@gmail.com</p>
					<p>
						By visiting this page on our website:{' '}
						<Link
							href='/contact'
							className='text-blue-600 hover:underline'>
							https://www.digitalharidwar.com/contact
						</Link>
					</p>
				</section>
			</div>
