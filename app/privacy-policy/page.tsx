		...
		<>
			...
			<div className='w-full bg-white mt-20 text-gray-800'>
				...
				<section className='w-full py-12 sm:py-16 md:py-32 bg-linear-to-r from-blue-600 to-cyan-400 text-white text-center'>
					...
					<p className='text-white/90 mt-3 text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4'>
						Last Updated: December 06, 2025
					</p>
				</section>

				{/* CONTENT */}
				<section className='max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16 space-y-6 sm:space-y-8 leading-relaxed text-sm sm:text-base md:text-lg'>
					<p>
					...
					<ul className='list-disc ml-6 space-y-2'>
						...
						<li>
							<b>Purpose:</b> These Cookies identify if users have accepted the
					...
					<h3 className='text-lg sm:text-xl font-semibold'>Law enforcement</h3>
					<p>
					...
					<ul className='list-disc ml-6 space-y-2'>
						<li>By email: yogeshggangwar@gmail.com</li>
						<li>
					...
					<div className='text-center pt-10'>
						<Link
							href='/contact'
							className='px-8 py-3 rounded-full bg-linear-to-r from-blue-600 to-cyan-400 text-white font-semibold shadow-lg hover:opacity-90 transition'>
							Contact Support
						</Link>
					</div>
				</section>
